 ...
 * Ed25519SignatureVerifier}. Future ML-DSA / SLH-DSA verifiers are registered under their
 * respective {@code algorithm_id} values without changing this class or the {@link
 * SignatureVerifier} interface.
 *
 * <p>Lives at the public {@code de.vvwt.info.crypto} surface (via interface) because it is consumed
 * by the registration service (E38S04) and the publish/tournament services (E38S05, E38S09).
 *
 * @see SignatureVerifier
 * @see Ed25519SignatureVerifier
...
public class DefaultSignatureVerifierRegistry implements SignatureVerifierRegistry {
     ...
     */
    public DefaultSignatureVerifierRegistry(Map<String, SignatureVerifier> verifiers) {
