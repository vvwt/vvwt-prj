 ...
 */
public class DefaultInvitationTokenPool implements InvitationTokenPool {
     ...
     */
    public DefaultInvitationTokenPool(
     ...
     * the DB insert are atomic (Spring {@code @Transactional} on the calling service method ensures
     * this).
     *
