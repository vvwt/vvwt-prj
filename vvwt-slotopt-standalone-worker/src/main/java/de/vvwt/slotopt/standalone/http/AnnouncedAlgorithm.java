 ...
 *
 * <p>This record is the standalone-worker's own DTO — no dependency on the dispatcher module is
 * required; only the wire shape must match (DEC-3 minimal-dependency).
 *
 * <p>Story: E41S04 AC-FETCH-ALGORITHMS-WIRE.
 */
