 ...
 *
 * <p>The caller is responsible for re-registering the new public key with the dispatcher via
 * the {@code register-key} endpoint, passing the old fingerprint as the {@code supersedes} field.
 * See Story E01S04 AC10 and DEC-6.
 *
