 ...
 *
 * <ul>
 *   <li>{@link #bestRank} — 0-based lexicographic rank of the permutation with the best (lowest)
 *       variety score in the packet. On a tie, the lowest rank wins (per Brief D-3).
 ...
 *   <li>{@link #permutationsScored} — the number of permutations evaluated, i.e. {@code rankTo -
 *       rankFrom}.
 *   <li>{@link #wallClockNanos} — elapsed wall-clock time in nanoseconds from the start of the hot
 *       loop to the end, measured via {@code System.nanoTime()} at packet boundaries only.
 * </ul>
 *
...
public record PacketResult(
        long bestRank, double bestScore, long permutationsScored, long wallClockNanos) {}
