...
/**
 * The API surface used at submit-job time. Contains the row&rarr;position-set topology
 * with NO team UUIDs, names, or other identity-bearing attributes per DEC-9.
 *
 * <p>{@code phaseId} is included as <em>audit-only metadata</em>: it is echoed back in
 * job and result records and dispatcher logs for human correlation, but MUST NOT
 * participate in the fingerprint computation or in any scoring.
 *
