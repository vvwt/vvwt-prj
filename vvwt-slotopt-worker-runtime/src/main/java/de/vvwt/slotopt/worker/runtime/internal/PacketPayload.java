 ...
 *
 * <p>Maps the JSON fields produced by the dispatcher's packet service to Java types for use by
 * {@link DefaultComputeStep} to invoke {@code PacketSolver.solvePacket}.
 *
 * <p>Package-private — used only within {@code runtime.internal}.
 *
 * <p>Story: E41S05 AC-PACKET-PROCESSING (moved to E63S01 shared library).
 */
class PacketPayload {
