 ...
 *
 * <p>DEC-11: no compile dependency on {@code vvwt-slotopt-dispatcher}; only the HTTP wire shape
 * must match (plain-Java HTTP client against documented API endpoints).
 *
 * <p>DEC-35-by-analogy: implementation resides in {@code runtime.internal}; the public interface
 * {@link DispatcherClient} is in the {@code runtime} package root.
 *
 * <p>Story: E41S04 AC-DEFAULT-DISPATCHER-CLIENT (moved to E63S01 shared library); E41S05
