 ...
 * resultPayloadJson} and JCS-canonicalizes before signature verification (per Brief D-10 + O-6
 * (ii)).
 *
 * <p>The canonical implementation is {@link
 * de.vvwt.slotopt.worker.runtime.internal.DefaultResultSigner}.
 *
 * <p>DEC-35-by-analogy: public interface in the {@code runtime} root package; implementation in
 * {@code runtime.internal}. Cross-module consumers use this interface exclusively.
 *
 * <p>Story: E41S03 AC-RESULT-SIGNER-INTERFACE (moved to E63S01 shared library).
 */
@FunctionalInterface
