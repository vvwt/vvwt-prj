...
/**
 * AC8 (security) — RegistrationRequest: algorithm_id required, public_key required, signature
 * NULLABLE. AC1 (testing) — round-trip tests. Also covers RegistrationResponse: nullable
 * tournament_token, optional algorithm_warning.
 *
...
class RegistrationRequestTest {
    ...
    void registrationResponse_roundTrip_withNullTournamentToken() throws Exception {
        // AC8 — tournament_token is nullable (populated by tournament-registration endpoint in
        // E38S05)
    ...
    void registrationResponse_roundTrip_withAlgorithmWarning() throws Exception {
        ...
        AlgorithmWarning warning =
                new AlgorithmWarning("ed25519", LocalDate.of(2028, 12, 31), 1000);
