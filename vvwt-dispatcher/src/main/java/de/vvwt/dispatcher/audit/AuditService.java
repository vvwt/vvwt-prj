...
/**
 * Writes append-only audit log entries for every {@code register-key} and
 * {@code submit-job} call.
 *
 * <p>Audit logging uses {@link Propagation#REQUIRES_NEW} so that the audit row
 * is persisted even when the outer transaction is rolled back due to a business
 * error — ensuring that rejected requests are also recorded (AC12).
 *
...
public class AuditService {
    ...
    public void log(HttpServletRequest request, String endpoint,
