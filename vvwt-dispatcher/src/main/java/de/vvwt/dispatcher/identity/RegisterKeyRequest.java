 ...
 *
 * <p>All fields are received as JSON. {@code publicKey} and {@code supersedes}
 * are Base64-encoded (standard Base64, no wrapping) representations of the
 * respective 32-byte raw Ed25519 key material.
 *
