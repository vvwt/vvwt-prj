 ...
 *
 * <p>Uses {@link Propagation#REQUIRES_NEW} so that the audit row is persisted even when the outer
 * transaction rolls back due to a business error — every call, successful or rejected, is logged
 * per DEC-6 mechanism 10.
 *
...
public class ResultAuditService {
     ...
     * @param signatureOutcome one of {@link ResultAuditEntry#SIG_VERIFIED}, {@link
     *     ResultAuditEntry#SIG_FAILED}, {@link ResultAuditEntry#SIG_NA}
    ...
    public void log(
        ...
        ResultAuditEntry entry =
                new ResultAuditEntry(
                        Instant.now(),
                        sourceIp,
                        workerKeyId,
                        packetId,
