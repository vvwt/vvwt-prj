 ...
 * <ol>
 *   <li>JCS canonicalization is applied to the original JSON bytes (AC6).</li>
 *   <li>The {@code RawPhaseDef} record can be deserialized independently
 *       after signature verification passes.</li>
 * </ol>
 *
 * <p>Jackson's {@code @JsonRawValue} / {@link RawPhaseDefDeserializer} pair handles
 * the round-trip: on deserialization the {@code phaseDef} field is captured as the
 * verbatim JSON string; on serialization it is emitted without re-encoding.
 *
