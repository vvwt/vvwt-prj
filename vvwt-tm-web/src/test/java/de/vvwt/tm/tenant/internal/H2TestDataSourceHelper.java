...
/**
 * Test-only helper for creating real H2 file-based DataSources and querying Flyway schema history
 * for IT assertions.
 *
...
final class H2TestDataSourceHelper {
    ...
    /**
     * Returns true if a table with the given name exists in the given DataSource. Uses an H2
     * information_schema query for reliable case-insensitive detection.
     */
    ...
    /**
     * Checks table existence via H2's INFORMATION_SCHEMA.TABLES query. This is more reliable than
     * {@link java.sql.DatabaseMetaData#getTables} with H2 file mode.
     */
    private static boolean tableExistsViaSql(Connection conn, String lowerTableName)
            throws SQLException {
