 ...
 *
 * <p>Constructor calls updated from {@code String} to GameMode (removed by E58S01) enum constants.
 * JSON deserialization test updated to use valid wire-format value {@code "roundRobin"} (was {@code
 * "roundrobin"} — an invalid value that would have been accepted before E51S20 but now correctly
 * fails at the Jackson boundary via GameMode.fromWireFormat (removed by E58S01)).
 *
 * @see DraftRequest
