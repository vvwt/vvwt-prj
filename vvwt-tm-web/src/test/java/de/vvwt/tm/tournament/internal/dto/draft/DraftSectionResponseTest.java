 ...
 *
 * <p>Constructor calls and assertions updated from {@code String} to GameMode (removed by E58S01)
 * enum constants. The {@code gameMode} field in both {@link DraftSection} and {@link
 * DraftSectionResponse} is now typed as GameMode (removed by E58S01).
 *
    ...
    void jsonRoundTrip_allFields_preserved() throws Exception {
        DraftSectionResponse original =
                new DraftSectionResponse(
                        1, "team_number", 2, "roundRobin", 5, 10, 15, 1, List.of(), null);
