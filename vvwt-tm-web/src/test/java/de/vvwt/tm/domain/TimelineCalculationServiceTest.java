 ...
 *
 * <p>Covers all acceptance criteria AC3–AC10 via pure unit tests (no Spring context needed — the
...
class TimelineCalculationServiceTest {
    ...
    /**
     * AC3: single phase, 4 laps, 15-min lap time, 5-min lap break, start 10:00. Expected: Lap 1
     * 10:00–10:15, LapBreak 10:15–10:20, Lap 2 10:20–10:35, LapBreak 10:35–10:40, Lap 3
     * 10:40–10:55, LapBreak 10:55–11:00, Lap 4 11:00–11:15. No trailing lap break after last lap
     * (AC6).
     */
    @Test
    void calculate_singlePhase_fourLaps_basicTimeline() {
        ...
        List<TimelineEntry> result = service.calculate(LocalTime.of(10, 0), List.of(phase), 0);
    ...
    /**
     * AC4: same as AC3 but with a 40-min intra-phase break after lap 2. Expected: Lap 1
     * 10:00–10:15, LapBreak 10:15–10:20, Lap 2 10:20–10:35, IntraPhaseBreak "Mittagspause"
     * 10:35–11:15, Lap 3 11:15–11:30, LapBreak 11:30–11:35, Lap 4 11:35–11:50.
     */
    @Test
    ...
    /**
     * AC5: two phases with a 10-min section break between them. Phase 1: 2 laps, 20 min each, no
     * lap break. Phase 2: 2 laps, 15 min each, no lap break. Timeline is continuous; phase 2 starts
    ...
    void calculate_twoPhases_withSectionBreak_continuousTimeline() {
        ...
        List<TimelineEntry> result =
                service.calculate(LocalTime.of(9, 0), List.of(phase1, phase2), 10);

        // Phase 1: 2 laps (no lap breaks); section break; Phase 2: 2 laps (no lap breaks) = 5
        // entries
    ...
    void calculate_twoPhases_zeroSectionBreak_noGapEntry() {
        ...
        List<TimelineEntry> result =
                service.calculate(LocalTime.of(9, 0), List.of(phase1, phase2), 0);
    ...
    void calculate_lastLap_noTrailingLapBreak() {
        ...
        List<TimelineEntry> result = service.calculate(LocalTime.of(8, 0), List.of(phase), 0);
    ...
    void calculate_intraPhaseBreak_afterLap1() {
        ...
        List<TimelineEntry> result = service.calculate(LocalTime.of(9, 0), List.of(phase), 0);
    ...
    void calculate_returnedList_isUnmodifiable() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
                UnsupportedOperationException.class, () -> result.add(null));
    }
