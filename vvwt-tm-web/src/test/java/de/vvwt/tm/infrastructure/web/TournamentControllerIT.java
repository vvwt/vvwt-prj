...
/**
 * Integration tests for {@link TournamentController} and ScoringRulesController (renamed from
 * TournamentRulesController at E21S20) (E05S04).
 *
 ...
 *
 * <ul>
 *   <li>AC1 — GET /api/tournaments returns 200 with list
 *   <li>AC2 — GET /api/tournaments/{id} returns 200 or 404
 ...
 *   <li>AC8 — GET /api/scoring/rules returns all dropdowns (renamed from /api/tournament-rules at
 *       E21S20)
...
class TournamentControllerIT {
    ...
    void getTournamentReturns200ForExistingTournament() throws Exception {
        // Create first
        TournamentCreateRequest create =
                new TournamentCreateRequest(
                        "For GET Test",
                        null,
                        4,
    ...
    // =========================================================================
    // AC8 — GET /api/scoring/rules (renamed from /api/tournament-rules at E21S20 per DEC-40
    // DDD-ownership)
    // =========================================================================
    ...
    void getTournamentRulesReturns200WithAllDropdowns() throws Exception {
        ...
        java.util.List<Object> matchFormats =
                (java.util.List<Object>) response.getBody().get("matchFormats");
