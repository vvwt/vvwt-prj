 ...
 * <ul>
 *   <li>AC1: Upload accepts .mp3, returns 201 with metadata</li>
 *   <li>AC2: Stream returns 200 audio/mpeg without auth; 404 if no file</li>
 *   <li>AC3: List returns 200 with metadata array (authenticated)</li>
 *   <li>AC4: Delete returns 204 (authenticated); 404 if no file</li>
 *   <li>AC5: Cross-tenant tournament → 404</li>
 *   <li>AC5a: Stream endpoint is public; upload/list/delete require auth</li>
 *   <li>AC7: Non-.mp3 → 415; oversized → 413 (Spring multipart); unknown tournament → 404</li>
 * </ul>
 *
 * <p>The test context uses an isolated in-memory H2 database and a temp directory for audio
 * file storage (overriding {@code tm.audio.data-dir}).
 *
 * @see AudioController
...
class AudioControllerIT {
    ...
    void uploadMp3Returns201() throws Exception {
        ...
        ResponseEntity<AudioMetadataResponse> response = uploadAudio(
                authed, tournamentId, AudioCategory.START, "start.mp3", SAMPLE_MP3);
    ...
    void uploadRequiresAuth() throws Exception {
        ...
        ResponseEntity<String> response = uploadAudioAsString(
    ...
    void streamReturns200AudioMpeg() throws Exception {
        ...
        ResponseEntity<byte[]> response = restTemplate.getForEntity(
                new URI(audioStreamUrl(tournamentId, AudioCategory.START)),
                byte[].class);
    ...
    void streamIsPublicWithoutAuth() throws Exception {
        ...
        ResponseEntity<byte[]> response = restTemplate.getForEntity(
                new URI(audioStreamUrl(tournamentId, AudioCategory.END)),
                byte[].class);
    ...
    void streamReturns404WhenNoFileUploaded() throws Exception {
        ...
        ResponseEntity<String> response = restTemplate.getForEntity(
                new URI(audioStreamUrl(tournamentId, AudioCategory.PAUSE)),
                String.class);
    ...
    void streamForUnknownTournamentReturns404() throws Exception {
        ...
        ResponseEntity<String> response = restTemplate.getForEntity(
                new URI(audioStreamUrl(unknownId, AudioCategory.START)),
                String.class);
    ...
    void listReturnsMetadata() throws Exception {
        ...
        ResponseEntity<AudioMetadataResponse[]> response = authed.getForEntity(
    ...
    private ResponseEntity<AudioMetadataResponse> uploadAudio(
            ...
            AudioCategory category, String filename, byte[] content) throws Exception {
