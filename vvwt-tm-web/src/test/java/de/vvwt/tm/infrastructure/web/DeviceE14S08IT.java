 ...
 * <ul>
 *   <li>AC3 — Registration no longer requires/uses location; location_id persisted as NULL</li>
 *   <li>AC4 — Admin endpoint POST /api/admin/devices/{deviceId}/location/{locationId}</li>
 *   <li>AC5 — Assignment round-trip: register → assign → reassign → unassign</li>
 *   <li>AC8 — Cross-tenant location assignment returns 400</li>
 *   <li>AC9 — DeviceController no longer imports DefaultTenantProvider (compile-time check)</li>
 * </ul>
 *
...
class DeviceE14S08IT {
    ...
    void assignLocationReturns200WithUpdatedDevice() throws SQLException {
        // AC4: POST /api/admin/devices/{id}/location/{locationId} must return 200 with updated device
        ...
        ResponseEntity<DeviceSummaryResponse> response = authed.postForEntity(
    ...
    void assignmentRoundTrip() throws SQLException {
        ...
        authed.postForEntity(
                baseUrl + "/api/admin/devices/" + deviceId + "/location/" + locationId,
                null, DeviceSummaryResponse.class);
        ...
        ResponseEntity<DeviceSummaryResponse> reassignResponse = authed.postForEntity(
                baseUrl + "/api/admin/devices/" + deviceId + "/location/" + locationId,
                null, DeviceSummaryResponse.class);
        ...
        ResponseEntity<DeviceSummaryResponse> unassignResponse = authed.exchange(
                baseUrl + "/api/admin/devices/" + deviceId + "/location",
                HttpMethod.DELETE, null, DeviceSummaryResponse.class);
    ...
    void assignCrossTenantLocationReturns400() {
        ...
        ResponseEntity<ApiErrorResponse> response = authed.postForEntity(
                baseUrl + "/api/admin/devices/" + deviceId + "/location/" + unknownLocationId,
