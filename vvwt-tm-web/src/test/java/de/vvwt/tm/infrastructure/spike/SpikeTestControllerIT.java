 ...
 * <ul>
 *   <li>Spike echo endpoint accessible without auth (SecurityConfig permits /score/spike/**)</li>
 *   <li>Spike page serving at /score/spike/</li>
 *   <li>Static JS asset accessible at /static/score/spike/spike-utils.js</li>
 * </ul>
 */
@SpringBootTest(
...
class SpikeTestControllerIT {
    ...
    void echoEndpoint_returns200WithoutAuth() throws Exception {
        ResponseEntity<String> response = restTemplate.getForEntity(
                new URI(baseUrl + "/score/spike/api/echo"), String.class);

        assertThat(response.getStatusCode())
                .as("Echo endpoint must be accessible without auth (SecurityConfig permits /score/spike/**)")
    ...
    /**
     * AC4/AC7: Spike test page accessible without auth.
     * Spring Boot serves classpath:/static/score/spike/test.html at URL /score/spike/test.html.
     */
    @Test
    ...
    /**
     * Test admin credentials for the Spring Security context.
     * Spike endpoints don't need auth, but the application context
     * requires a valid AdminCredentialsProvider.
     */
    @TestConfiguration
