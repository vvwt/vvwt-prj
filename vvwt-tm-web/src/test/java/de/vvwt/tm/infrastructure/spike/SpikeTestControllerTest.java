 ...
 * <ul>
 *   <li>AC1: echo endpoint returns JSON with status, message, and timestamp</li>
 *   <li>AC4/AC7: spike page redirects to the static HTML file</li>
 * </ul>
 */
...
class SpikeTestControllerTest {
    ...
    void setUp() {
        mockMvc = MockMvcBuilders
                .standaloneSetup(new SpikeTestController())
                .build();
    }

    @Test
    @DisplayName("AC1: GET /score/spike/api/echo returns 200 with JSON containing status and timestamp")
    ...
    @Test
    @DisplayName("AC4/AC7: GET /score/spike (no trailing slash) redirects to static spike test page")
