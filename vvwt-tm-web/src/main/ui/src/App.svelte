<script lang="ts">
   ...
   * Story E05S08 — adds /tournaments/:tournamentId/phases/:phaseId/mapping route.
   *
  ...
  import PhaseMapping from './routes/PhaseMapping.svelte';
  ...
  const routes = new Map([
    ...
    ['/tournaments/:tournamentId/phases/:phaseId/mapping', PhaseMapping],
  ]);
