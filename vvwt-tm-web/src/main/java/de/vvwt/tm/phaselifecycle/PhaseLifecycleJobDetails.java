...
/**
 * Projection of a claimed {@code phase_lifecycle_job} row carrying the fields needed by {@link
 * de.vvwt.tm.phaselifecycle.internal.DefaultPhaseLifecycleOrchestrator} to execute the MatchGen →
 * L1+L2 → SlotOpt pipeline.
 *
