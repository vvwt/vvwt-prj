...
public interface DraftService {
    ...
    /**
     * Atomically applies the draft configuration to create Phase entities, persist the draft
     * config, and transition the tournament from DRAFT to PLANNED (E48S22,
     ...
     *     current status is not {@code DRAFT} (→ HTTP 409 with messageKey {@code
