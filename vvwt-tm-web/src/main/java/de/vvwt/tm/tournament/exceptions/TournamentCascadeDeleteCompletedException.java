...
/**
 * Thrown when cascade-delete is attempted on a COMPLETED tournament (E48S13,
 * AC-IMPL-TYPED-EXCEPTIONS-AND-HANDLERS).
 *
 * <p>COMPLETED tournaments cannot be deleted. HTTP 409 Conflict via {@link
 ...
 */
public class TournamentCascadeDeleteCompletedException extends ConflictException {
     ...
     */
    public TournamentCascadeDeleteCompletedException(UUID id) {
        super("Tournament '" + id + "' is COMPLETED and cannot be deleted.");
    }
}
