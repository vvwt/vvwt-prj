 ...
 * {@code ~/.vvwt-tm}. Override via environment variable {@code TM_AUDIT_LOG_DATA_DIR} or JVM
 * property {@code -Dtm.audit-log.data-dir}.
 *
...
public class AuditLogConfig {
     ...
     *
     * <p>Default: {@code ${user.home}/.vvwt-tm}. Override via {@code -Dtm.audit-log.data-dir} or
     * environment variable {@code TM_AUDIT_LOG_DATA_DIR}.
     */
    private String dataDir = System.getProperty("user.home") + "/.vvwt-tm";
