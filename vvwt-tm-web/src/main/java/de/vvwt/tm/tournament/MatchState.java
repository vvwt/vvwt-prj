...
/**
 * Lifecycle states for a {@link Match} entity (DEC-21, DEC-22, DEC-26, E21S05).
 *
 * <p>Reconstruction-in-place counterpart of {@code de.vvwt.tm.domain.MatchState} (READ ONLY
 * reference; not imported). Integer codes are preserved character-for-character for DB/wire
 * compatibility with the legacy system (AC-ENUM-VALUES-STABLE).
 *
 * <p>Boundary-API (public surface of the {@code tournament} Modulith context) per inventory line
 * 176 — cross-context scoring + display consumers use {@code MatchState} in method signatures.
 *
 ...
 *
 * <p>State transitions are owned by the cascade service (E03S11 / future E22). The {@link
 * MatchFormat#deriveMatchState} helper derives a terminal/ongoing verdict from set scores but does
 * not assign {@code INPROGRESS} — that is set externally when play begins.
 *
 * @see Match
 * @see MatchFormat
 ...
 * @see <a href="E21S05">E21S05 — inventory line 176</a>
 */
    ...
    public static MatchState fromLegacyCode(int code) {
        ...
        throw new IllegalArgumentException(
                "Unknown MatchState legacy code: "
                        ...
                        + " 50 (FINISHED_STANDOFF), 51 (FINISHED_WINNER1), 52 (FINISHED_WINNER2),"
                        + " -10 (CANCELED)");
    }
}
