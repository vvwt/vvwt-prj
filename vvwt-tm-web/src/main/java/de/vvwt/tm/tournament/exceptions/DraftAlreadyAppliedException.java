 ...
 *
 * <p>Maps to HTTP 409 Conflict via {@link de.vvwt.tm.web.GlobalExceptionHandler}'s
 * {@code @ExceptionHandler(ConflictException.class)} handler. Extends {@link ConflictException}
 * (E21S19) so that the global handler can catch it uniformly without a dedicated per-exception
 * mapping.
 *
 ...
 * @see <a href="E21S19">E21S19 — extends ConflictException for GlobalExceptionHandler
 *     unification</a>
 */
