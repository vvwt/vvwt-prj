 ...
 * D-3, E51S03).
 *
 * <p>Published by {@link de.vvwt.tm.tournament.internal.DefaultMatchGenJobListener} after
 * successful match-generation IF {@code tournament.optimize=true}. Consumed by {@code
 * SlotOptJobScheduler} (tournament context, E51S04) which enqueues the phase into the
 * per-tournament FIFO queue (DEC-55 D-3a). The listener for this event is wired in E51S04 — this
 * story only publishes the event "into the void".
 *
