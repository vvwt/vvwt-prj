 ...
 *
 * @see <a href="../../../../../../../../.gaai/project/contexts/artefacts/stories/E05S06.story.md">Story E05S06 AC2, AC3</a>
 */
public record DraftResponse(List<DraftSectionResponse> sections) {
    ...
    public static DraftResponse from(DraftConfig config) {
        List<DraftSectionResponse> sectionResponses = config.getSections().stream()
                .map(DraftSectionResponse::from)
                .toList();
