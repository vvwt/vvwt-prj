 ...
 * <ul>
 *   <li>{@code placement} — 1-based ordinal integer string (e.g., {@code "1"})</li>
 *   <li>{@code teamName}  — team description string</li>
 *   <li>{@code teamPhoto} — base64 data URI for SVG path, API URL for HTML path, or empty string if no photo</li>
 *   <li>{@code tournamentName} — tournament description string</li>
 *   <li>{@code date}      — formatted date string (e.g., {@code "15. April 2026"})</li>
 *   <li>{@code location}  — location display name string</li>
 * </ul>
 *
