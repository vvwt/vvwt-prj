...
public record DeviceConfigureRequest(
        ...
        @NotBlank(message = "deviceName must not be blank") String deviceName,

        /**
         * JSON configuration string controlling the device's display behaviour (AC4). Example:
         * {@code {"display_schema": "OVERVIEW"}}. Null clears the current configuration (unassigns
         * the display schema).
         */
