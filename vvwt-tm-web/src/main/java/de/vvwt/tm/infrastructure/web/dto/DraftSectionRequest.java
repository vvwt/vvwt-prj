 ...
 * is performed by {@link de.vvwt.tm.domain.draft.DraftSection#validate()} and
 * {@link de.vvwt.tm.domain.draft.DraftSection#validateBreaks(int)}.
 *
 * <p>E08S05: the {@code breaks} field is added to support intra-phase break configuration (AC2, AC5).
 *
 * @see DraftRequest
...
public record DraftSectionRequest(
        ...
        /**
         * Optional intra-phase breaks for this section (AC2 — E08S05).
         * May be {@code null} (treated as empty list). Each break is independently validated.
         */
        @Valid
        List<DraftBreakRequest> breaks
