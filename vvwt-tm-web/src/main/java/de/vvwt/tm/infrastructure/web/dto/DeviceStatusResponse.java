 ...
 *
 * <p>The tablet / display device polls this endpoint after registration. Extended in E07S02
 * to include {@code configuration} and {@code deviceName} for display devices (AC3).
 *
...
public record DeviceStatusResponse(
        ...
        /**
         * JSON configuration string (E07S02 AC3) — controls what a display device shows.
         * Null for scoring tablets and unconfigured display devices; omitted from JSON when null.
         */
        String configuration,
        /**
         * Human-readable device name (E07S02 AC3) — set by admin via configure endpoint.
         * Null for scoring tablets and unnamed display devices; omitted from JSON when null.
         */
        String deviceName
) {
