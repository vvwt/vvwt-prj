package de.vvwt.tm.infrastructure.internal;

import de.vvwt.tm.infrastructure.TmStartupLogger;
...
/**
 * Default implementation of {@link TmStartupLogger}.
 *
 * <p>Emits a structured startup log block after the application is fully initialised.
 *
 ...
 *     E02S02</a>
 * @since E57S01 (DEC-58/DEC-72 interface extraction: renamed from TmStartupLogger, moved to
 *     infrastructure.internal, implements {@link TmStartupLogger})
 */
@Component
public class DefaultTmStartupLogger implements TmStartupLogger {

    private static final Logger log = LoggerFactory.getLogger(DefaultTmStartupLogger.class);
