 ...
 *
 * <p>Carries the current match state for the given court field in the active lap. Used by the
 * Mustache scoring page's inline ES5 script to populate the match display and score entry area on
 * load and after each WebSocket notification.
 *
 * <p>All text fields are data values (team names, referee name) — i18n labels for buttons and
 * headings are rendered server-side via the Mustache template / messages.properties (AC13).
 *
