 ...
 *
 * <p>Returns all matches for the given (or current) lap in the active phase, including
 * team names, set results, match status, and referee team name.
 *
 ...
 */
public record DisplayMatchesResponse(
        UUID phaseId,
        int lap,
