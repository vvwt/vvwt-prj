 ...
 *
 * <p>Returned as part of {@link DraftPreviewResponse#timeline()} when a tournament has a
 * {@code plannedStartTime} set. Exposes the phase number, lap number, type, start time,
 * end time, and optional label for each timeline entry.
 *
 * <p>The {@code type} field uses the string name of
 * {@link de.vvwt.tm.domain.timeline.TimelineEntryType}:
 * {@code MATCH_ROUND}, {@code LAP_BREAK}, {@code INTRA_PHASE_BREAK}, {@code SECTION_BREAK}.
 *
