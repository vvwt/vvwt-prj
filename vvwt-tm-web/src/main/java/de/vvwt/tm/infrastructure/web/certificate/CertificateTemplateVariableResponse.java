 ...
 *
 * <p>Returned by {@code GET /api/certificate-template/variables} — the system-level
 * endpoint that documents available Mustache placeholders for template authors.
 *
 ...
 */
public record CertificateTemplateVariableResponse(
        String name,
        String type,
        String example
) {
