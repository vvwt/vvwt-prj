 ...
 *
 * <p>Returns group standings for the current active phase. Each group contains a list of team
 * rankings ordered by position (D-33 sort order: points DESC, set quotient DESC, ball quotient
 * DESC, withoutAssessment last).
 *
