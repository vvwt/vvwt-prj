 ...
 *
 * <p>Returns the device token and PIN after a successful registration.
 * The tablet stores the device token for subsequent polling;
 * the PIN is displayed to the operator for assignment.
 */
