 ...
 *
 * <p>Each URL field points to the audio streaming endpoint for the given category
 * ({@code /api/tournaments/{tournamentId}/audio/{category}/stream}).
 * A {@code null} value means no file has been uploaded for that category — the timer
 * should not attempt to play audio for that event.
 *
...
public class TimerAudioResponse {
     ...
     * Points to {@code /api/tournaments/{tournamentId}/audio/START/stream}.
     */
    private String startUrl;

    /**
     * URL of the end-of-round audio file, or {@code null} if none uploaded.
     * Points to {@code /api/tournaments/{tournamentId}/audio/END/stream}.
     */
    private String endUrl;

    /**
     * URL of the pause-music audio file, or {@code null} if none uploaded.
     * Only played during {@code REGULAR} breaks (D-8 / AC3).
     * Points to {@code /api/tournaments/{tournamentId}/audio/PAUSE/stream}.
     */
    ...
    public String getPauseUrl() { return pauseUrl; }
    public void setPauseUrl(String pauseUrl) { this.pauseUrl = pauseUrl; }
}
