 ...
 * <ul>
 *   <li>{@link MatchResultChangedEvent} — AC2, AC3: match result changed → update match row + standings</li>
 *   <li>{@link LapAdvancedEvent} — AC4: current lap advanced → refresh match grid</li>
 *   <li>{@link PhaseStatusChangedEvent} — AC5: phase transitioned → reload entire layout</li>
 * </ul>
 *
...
public class DomainEventBridge {
    ...
    /** Event type constants for the {@link EventMessage#getEventType()} field. */
