 ...
 *
 * <p>All required fields are annotated with {@link NotBlank} or {@link NotNull} + {@link Min}.
 * Validation errors are handled by {@link de.vvwt.tm.infrastructure.web.GlobalExceptionHandler} and
 * returned as HTTP 400 with field-level error details (AC10).
 *
 * @see <a
