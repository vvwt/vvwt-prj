 ...
 *
 * <ul>
 *   <li>PUT /api/tournaments/{tournamentId}/draft — save draft (AC2)
 *   <li>GET /api/tournaments/{tournamentId}/draft — get draft (AC3)
 *   <li>POST /api/tournaments/{tournamentId}/draft/preview — preview draft (AC4)
 *   <li>POST /api/tournaments/{tournamentId}/draft/apply — apply draft (AC5)
 * </ul>
 *
 ...
 * <h2>Security (AC14)</h2>
 *
 * <p>All /api/** endpoints require HTTP Basic authentication. Tenant scoping is enforced at the
 * repository layer via TenantContext (DEC-5, DEC-17).
 *
 * @see <a
...
public class DraftController {
     ...
     *
     * <p>Transitions the tournament status from DRAFT to PLANNED (AC7). The draft can no longer be
