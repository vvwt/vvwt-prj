 ...
 *
 * <p>The {@code hasPhoto} field (E12S02 AC4) indicates whether a team photo has been
 * uploaded for this team in its tournament. Populated by the listing endpoint; defaults
 * to {@code false} for responses that do not require photo presence information.
 *
...
public record TeamResponse(
    ...
    /**
     * Maps a {@link Team} domain entity to a {@link TeamResponse} DTO with {@code hasPhoto = false}.
     *
    ...
    /**
     * Maps a {@link Team} domain entity to a {@link TeamResponse} DTO with the given
     * {@code hasPhoto} value (E12S02 AC4).
     *
     * @param t        the team entity (must not be {@code null})
