 ...
 *
 * <p>Story E11S01 — AC7: File exceeds configurable size limit (default 10 MB) → 413. Mapped to HTTP
 * 413 by {@link de.vvwt.tm.infrastructure.web.GlobalExceptionHandler}.
 *
 * @see <a
