 ...
 *
 * <p>Instances are produced by {@link AudioStorageService} after a successful upload
 * or list operation. No database persistence — metadata is derived from the filesystem
 * at query time per DEC-15 (files stored outside the jlink archive).
 *
