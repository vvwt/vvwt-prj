...
/**
 * Spring Data JDBC delegate for {@link MatchOutcome} persistence. Wired into {@link
 * MatchOutcomeRepository} as the low-level CRUD provider.
 */
interface MatchOutcomeCrudRepository extends CrudRepository<MatchOutcome, UUID> {
     ...
     *
     * <p>Used by {@link MatchOutcomeRepository#deleteByMatchId} which applies the tenant guard
