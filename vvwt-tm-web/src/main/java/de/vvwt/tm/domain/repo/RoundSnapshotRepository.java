...
public class RoundSnapshotRepository extends TenantScopedRepository<RoundSnapshot, UUID> {
    ...
    public RoundSnapshotRepository(
            RoundSnapshotCrudRepository delegate,
    ...
    @Override
    protected CrudRepository<RoundSnapshot, UUID> delegate() {
        return delegate;
    }
    ...
    @Override
    protected UUID extractTenantId(RoundSnapshot e) {
        return e.getTenantId();
    }

    @Override
    protected void setTenantId(RoundSnapshot e, UUID id) {
        e.setTenantId(id);
    }

    @Override
    protected UUID extractId(RoundSnapshot e) {
        return e.getId();
    }
}
