 ...
 *
 * <p>Returned by {@link PhotoStorageService#upload} and {@link PhotoStorageService#retrieve}
 * when metadata is needed without the file content itself.
 *
 ...
 */
public record PhotoFileMetadata(
        String filename,
        long sizeBytes,
        Instant uploadedAt
) {}
