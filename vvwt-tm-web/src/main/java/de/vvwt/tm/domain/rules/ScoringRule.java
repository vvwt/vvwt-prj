 ...
 * service (E03S11) resolves the applicable rule via {@code Tournament.scoringRuleId} through the
 * {@link ScoringRuleRegistry}, then calls this method to compute per-match points before updating
 * {@code TeamAvatarRating} aggregates.
 *
 * <p>V1 implementations:
 *
 * <ul>
 *   <li>{@code setPoints} — 1 point per set won by each team ({@link SetPointsRule})
 *   <li>{@code twoPoint} — winner 2 / loser 0, ties 1/1 ({@link TwoPointMatchRule})
 *   <li>{@code threePoint} — winner 3 / loser 0, tie-break winner 2 / loser 1 ({@link
 *       ThreePointMatchRule})
 * </ul>
 *
