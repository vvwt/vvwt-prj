 ...
 * natural here than the INSERT/UPDATE decision in {@link TenantScopedRepository}.
 *
 * <h2>Tenant scoping (AC8, DEC-5, DEC-17)</h2>
 *
 * <p>Tenant isolation is enforced at the service layer via {@link
 * TournamentRepository#findById(Object)}, which returns empty if the tournament does not exist or
 * belongs to a different tenant. This repository itself only operates on the {@code tournament_id}
 * FK — it trusts that the caller has validated tournament ownership.
 *
 * <h2>DEC-14</h2>
 *
