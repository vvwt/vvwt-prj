...
/**
 * Spring Data JDBC delegate for {@link Phase} persistence. Wired into {@link PhaseRepository} as
 * the low-level CRUD provider.
 */
interface PhaseCrudRepository extends CrudRepository<Phase, UUID> {

    /**
     * Returns all phases belonging to the given tournament (unscoped — tenant filtering is applied
     * in {@link PhaseRepository#findByTournamentId(UUID)}).
     *
