 ...
 * Photo files are stored in a user-writable location on the host filesystem.
 *
 * <p>Example override:
 * <pre>
 * tm:
...
public class PhotoStorageConfig {
    ...
    /**
     * Root directory for team photo storage. Subdirectories are created automatically
     * per tournament: {@code {dataDir}/{tournamentId}/{teamId}.{ext}}.
     *
     * <p>Default: {@code ${user.home}/.tournament-manager/photos}.
     * Override via {@code TM_PHOTOS_DATA_DIR} env var or {@code -Dtm.photos.data-dir}.
     */
     ...
     * Override via {@code -Dtm.photos.max-size-bytes}.
     */
