 ...
 *
 * <ul>
 *   <li>AC3: Only teams in DRAFT tournaments may be updated
 *   <li>AC4: Only teams in DRAFT tournaments with no TeamAvatar references may be deleted
 *   <li>AC10: team_number must be unique within a tournament (409 on duplicate)
 *   <li>AC11: modification operations on non-DRAFT tournaments return 409
 *   <li>AC13: tournament ownership (tenant scope) is enforced by TournamentRepository
 * </ul>
 *
 ...
 *
 * @see <a href="../../../../../../.gaai/project/contexts/artefacts/stories/E05S05.story.md">Story
 *     E05S05</a>
 */
@Service
public class TeamService {
     ...
     * team_number (within the batch or against existing teams), that team's result carries an error
     * — the successfully created teams are returned in the same response.
     *
     * <p>This method uses a best-effort strategy: it attempts to create each team and collects
     * results per-item. Caller receives a list of {@link BulkCreateResult} entries.
     *
     * @param tournamentId the tournament UUID
