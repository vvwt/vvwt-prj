...
public class TeamAvatarRatingRepository extends TenantScopedRepository<TeamAvatarRating, UUID> {
    ...
    public TeamAvatarRatingRepository(
            TeamAvatarRatingCrudRepository delegate,
    ...
    @Override
    protected CrudRepository<TeamAvatarRating, UUID> delegate() {
        return delegate;
    }
    ...
    @Override
    protected UUID extractTenantId(TeamAvatarRating e) {
        return e.getTenantId();
    }

    @Override
    protected void setTenantId(TeamAvatarRating e, UUID id) {
        e.setTenantId(id);
    }

    @Override
    protected UUID extractId(TeamAvatarRating e) {
