 ...
 *
 * <p>Carries the score for a single set within a match, plus optional audit metadata. Immutable
 * record — all validation of set scores is performed by the {@code SetValidationRule} inside the
 * cascade service.
 *
...
public record SetResultInput(
    ...
    /**
     * Convenience factory for legacy callers that do not supply source fields (backward-compatible
     * with pre-E06S06 code).
     *
     * @param matchId UUID of the match being scored (NOT NULL)
