 ...
 *
 * <p>Translated to HTTP 429 (Too Many Requests) by
 * {@link de.vvwt.tm.infrastructure.web.GlobalExceptionHandler}.
 *
 * <p>The {@code currentCount} and {@code maxCount} fields are included in the
 * error response body per AC8 (structured error with current count and maximum).
 *
