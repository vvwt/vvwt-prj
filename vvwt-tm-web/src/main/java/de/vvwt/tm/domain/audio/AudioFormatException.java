 ...
 *
 * <p>Story E11S01 — AC7: Non-.mp3 upload → 415 with message naming allowed formats. Mapped to HTTP
 * 415 by {@link de.vvwt.tm.infrastructure.web.GlobalExceptionHandler}.
 *
 * @see <a
