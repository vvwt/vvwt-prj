...
public class TournamentRepository extends TenantScopedRepository<Tournament, UUID> {
    ...
    public TournamentRepository(TournamentCrudRepository delegate,
    ...
    @Override protected CrudRepository<Tournament, UUID> delegate() { return delegate; }
    ...
    @Override protected UUID extractTenantId(Tournament e) { return e.getTenantId(); }
    @Override protected void setTenantId(Tournament e, UUID id) { e.setTenantId(id); }
    @Override protected UUID extractId(Tournament e) { return e.getId(); }
}
