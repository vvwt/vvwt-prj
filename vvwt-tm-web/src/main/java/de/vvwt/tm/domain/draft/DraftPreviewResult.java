 ...
 *
 * <p>Combines the structural preview (section counts) with the optional time-aware timeline. The
 * {@code timeline} list is empty when no {@code plannedStartTime} is set on the tournament,
 * preserving backward compatibility with E05S06 clients.
 *
...
public record DraftPreviewResult(
        List<DraftPreviewSection> sections, List<TimelineEntry> timeline) {}
