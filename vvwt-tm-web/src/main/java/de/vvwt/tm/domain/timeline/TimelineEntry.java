 ...
 * Each entry represents either a match round or one of the break types defined by
 * {@link TimelineEntryType}.
 *
 * <p>Field semantics:
 * <ul>
 *   <li>{@link #phaseNumber} — 1-based phase index within the tournament</li>
 *   <li>{@link #lapNumber}   — 1-based lap index within the phase; 0 for break entries and for
 *                              zero-lap phase markers</li>
 *   <li>{@link #type}        — classifies the entry; drives display logic in consumers</li>
 *   <li>{@link #startTime}   — wall-clock start; derived from the tournament start time</li>
 *   <li>{@link #endTime}     — wall-clock end; {@code startTime + duration}</li>
 *   <li>{@link #label}       — non-null only for {@link TimelineEntryType#INTRA_PHASE_BREAK}
 *                              entries that carry an organiser-entered label</li>
 * </ul>
 *
 ...
 * @param label        optional display label; non-null only for INTRA_PHASE_BREAK entries that
 *                     have an organiser label
 *
