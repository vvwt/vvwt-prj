 ...
 * <ul>
 *   <li>{@link de.vvwt.tm.domain.timeline.TimelineEntryType#LAP_BREAK} →
 *       {@link #REGULAR} — inter-round break; triggers pause music (D-8)</li>
 *   <li>{@link de.vvwt.tm.domain.timeline.TimelineEntryType#INTRA_PHASE_BREAK} →
 *       {@link #ADDITIONAL} — organiser-configured phase pause; does NOT trigger pause music</li>
 *   <li>{@link de.vvwt.tm.domain.timeline.TimelineEntryType#SECTION_BREAK} →
 *       {@link #ADDITIONAL} — between-phase gap; does NOT trigger pause music</li>
 * </ul>
 *
