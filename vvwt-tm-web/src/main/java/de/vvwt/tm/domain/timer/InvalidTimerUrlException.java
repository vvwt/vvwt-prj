 ...
 *
 * <p>Story E11S02 AC7 — maps to HTTP 404 with error code {@code "INVALID_TIMER_URL"}. This is
 * distinct from {@link NoActiveTournamentException} which signals that a valid tournament exists
 * but is in a non-timer-accessible status (DRAFT or CANCELLED).
 *
