 ...
 * stateless and has no database access — the caller constructs these records from {@link
 * de.vvwt.tm.domain.Phase} and {@link de.vvwt.tm.domain.PhaseBreak} entities.
 *
 ...
 * @param lapCount number of laps (match rounds) in this phase; a value of 0 produces a single
 *     marker entry with {@link TimelineEntryType#MATCH_ROUND} and zero duration (AC7)
