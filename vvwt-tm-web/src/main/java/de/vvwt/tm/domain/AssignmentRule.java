 ...
 *
 * <p>The {@code assignment_rule} column in the {@code activity_types} table stores the
 * {@linkplain #name() enum name} as a VARCHAR. Adding a new rule post-V1 requires:
 * <ol>
 *   <li>Adding a new constant to this enum.</li>
 *   <li>Implementing the rule logic in the assignment service (E08S04).</li>
 *   <li>No schema migration — the VARCHAR column is rule-name-agnostic.</li>
 * </ol>
 *
 * <h2>V1 rule</h2>
 * <ul>
 *   <li>{@link #FIRST_FREE_ROUND} — assign the team to the activity during its first
 *       free (non-playing) round in the phase.</li>
 * </ul>
 *
 * @see ActivityType
