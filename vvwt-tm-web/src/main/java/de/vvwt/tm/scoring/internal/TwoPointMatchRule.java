 ...
 * "twoPoint"} — the value persisted in {@code Tournament.scoring_rule_id} per V2__e03_core_schema
 * (AC-BEAN-NAME-PRESERVED / E22S04).
 *
 * <p>Reconstructed from {@code de.vvwt.tm.domain.rules.TwoPointMatchRule} per DEC-22
 ...
 */
@Component("twoPoint")
class TwoPointMatchRule implements ScoringRule {
