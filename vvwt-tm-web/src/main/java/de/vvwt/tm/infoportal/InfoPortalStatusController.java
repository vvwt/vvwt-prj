 ...
 *
 * <p>Exposes {@code GET /api/info-portal/status} returning a JSON view of
 * {@link PublisherStatus}. Used by the {@code InfoPortalStatus.svelte} component to
 * surface algorithm-deprecation warnings and error states in the admin UI.
 *
 * <p>Activated only when {@code info-portal.url} is configured (registered by
 * {@link InfoPortalConfig#infoPortalStatusController} which is
 * {@code @ConditionalOnProperty(prefix="info-portal", name="url")}). Not component-scanned
 * directly — must be registered via the config factory method.
 *
 * @see <a href="../../../../../../../../.gaai/project/contexts/artefacts/stories/E38S09.story.md">E38S09 AC4, AC10</a>
...
public class InfoPortalStatusController {
    ...
    public ResponseEntity<StatusResponse> getStatus() {
        ...
        if (s.hasDeprecationWarning()) {
            warningDto = new DeprecationWarningDto(
