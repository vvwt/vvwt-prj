...
/**
 * Default implementation of {@link InfoPortalStateDao}.
 *
 * <p>JDBC DAO for the {@code info_portal_state} table (AC12). Managed by Spring as a
 * {@code @Repository}. Per-tenant DataSource is provided by the TM per-tenant routing
 * infrastructure (DEC-20 DB-per-Tenant).
 *
 * <p>Key contract (AC12):
 *
 * <ul>
 ...
 * @since E57S01 (DEC-58/DEC-72 interface extraction: renamed from InfoPortalStateDao, moved to
 *     infoportal.internal, implements {@link InfoPortalStateDao})
 */
@Repository
public class DefaultInfoPortalStateDao implements InfoPortalStateDao {

    private final JdbcTemplate jdbc;

    public DefaultInfoPortalStateDao(DataSource dataSource) {
