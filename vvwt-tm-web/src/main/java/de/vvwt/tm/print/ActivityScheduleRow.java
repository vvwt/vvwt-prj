 ...
 *
 * <p>This value object is used by {@link ActivityScheduleAssembler} and rendered by the Mustache
 * print template. jmustache accesses each field by name (getter-based), so standard JavaBean
