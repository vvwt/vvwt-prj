 ...
 * message)}.
 *
 * <p>Maps to HTTP 500 via {@link de.vvwt.tm.web.GlobalExceptionHandler} (E36S08 Phase 3 — {@code
 * PhotoExceptionAdvice} deleted in Phase 2). The message is included in the response body to aid
 * operator diagnosis.
 *
