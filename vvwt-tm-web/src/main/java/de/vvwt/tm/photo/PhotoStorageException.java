...
/**
 * Thrown when a filesystem I/O error occurs during photo storage operations
 * (E36S01 Q-1a TDD rebuild).
 *
 * <p>Rebuilt from deleted Q-1b artefact at the same canonical FQN ({@code de.vvwt.tm.photo})
 * per Brief D-7 Option γ. Constructor signatures preserved verbatim per
 * AC-EXCEPTION-CONSTRUCTORS-PRESERVED:
 * {@code (String message, Throwable cause)} and {@code (String message)}.
 *
 * <p>Maps to HTTP 500 via {@link de.vvwt.tm.web.photo.PhotoExceptionAdvice}.
 * The message is included in the response body to aid operator diagnosis.
 *
