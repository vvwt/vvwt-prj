 ...
 * Brief D-7 Option γ. Signature preserved verbatim per AC-RECORD-FIELDS-PRESERVED: {@code (String
 * filename, long sizeBytes, Instant uploadedAt)}.
 *
 * <p>Returned by {@link PhotoStorageService#upload} and included in {@link
 * PhotoStorageService.PhotoResult} from {@link PhotoStorageService#retrieve}.
 *
