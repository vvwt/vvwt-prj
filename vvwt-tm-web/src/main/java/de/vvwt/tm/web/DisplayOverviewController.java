...
/**
 * REST controller for display device tournament overview endpoints — E25S02 Q-1a TDD
 * reconstruction.
 *
 ...
 * {@code de.vvwt.tm.display.*} per DEC-40 §2026-04-27 Clarification Pattern A —
 * bounded-context-owned query-shape records. No web-tier DTO wrapping (AC-RECORDS-AUTHORED-BY-S01).
 *
 ...
 *
 * <p>When no active phase exists, the service throws {@link
 * de.vvwt.tm.display.NoActivePhaseException}, which is translated to HTTP 404 with body {@code
 * {"status":"NO_ACTIVE_PHASE"}} by {@link GlobalExceptionHandler#handleNoActivePhase}. The handler
 * now imports {@code de.vvwt.tm.display.NoActivePhaseException} per
 * AC-GLOBAL-EXCEPTION-HANDLER-IMPORT-UPDATE (updated by E25S01, verified here).
 *
 ...
 *   <li>DEC-40 §2026-04-27 Clarification Pattern A — response records at {@code
 *       de.vvwt.tm.display.*} consumed cross-module via {@code web→display} allowedDependency; no
 *       {@code web.internal.dto.*} created for display records (AC-RECORDS-AUTHORED-BY-S01)
 *   <li>DEC-22 Iron Law Q-1a — authored RED-first: {@link DisplayOverviewControllerIT} written
 *       before this class; RED commit 42c263d; GREEN commit = this class
...
public class DisplayOverviewController {
     ...
     * {@code de.vvwt.tm.display.*} per DEC-40 §2026-04-27 Clarification Pattern A. Includes {@code
     * tenantId} field critical for WebSocket STOMP-topic construction per O-9.
     *
