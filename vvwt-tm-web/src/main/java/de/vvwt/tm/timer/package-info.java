 ...
 * of this module (not a separate Modulith module) per user decision option A (2026-04-27). Consumers
 * reaching {@code timer.audio.*} types do so via the {@code "timer"} entry in their
 * {@code allowedDependencies} — no separate {@code "timer::audio"} named interface is needed.
 *
 ...
 *
 * <p>Reconstruction of legacy {@code de.vvwt.tm.domain.timer} package (no {@code
 * @ApplicationModule} declaration) via D-7 Coexistence Option γ (E26S01). Story E26S01.
 *
 * @since E26S01
 */
