 ...
 *
 * <p>Implemented via a stack ({@code ArrayDeque}) per thread, mirroring the {@link
 * ThreadLocalTenantContextImpl} pattern established in E14S03:
 *
 * <ul>
 ...
 *       scope restores the outer location.
 * </ul>
 *
 ...
 * This is a Wave-1 documentation obligation; automatic propagation is Wave-2 scope. See {@link
 * LocationContext} Javadoc for the full list.
 *
 * @see LocationContext
...
public class ThreadLocalLocationContextImpl implements LocationContext {
     ...
     * {@inheritDoc}
     *
     * @throws IllegalStateException if no location is bound to the current thread. This is a
     ...
     * {@inheritDoc}
     *
     * <p>Pushes {@code locationId} onto the per-thread stack. Closing the returned {@link Scope}
     * pops it, restoring the previous location (or leaving the stack empty if there was no outer
     * binding).
     *
