 ...
 *       closing the inner scope restores the outer tenant.</li>
 * </ul>
 * This story (E14S03) does NOT re-open or refine this contract — it implements the interface
 * as specified in E14S01's Javadoc.
 *
 ...
 * {@code @Transactional(propagation=REQUIRES_NEW)}. Callers crossing these boundaries must
 * capture the tenant UUID via {@link #current()} before crossing, then re-bind inside the async
 * block. This is a Wave-1 documentation obligation; automatic propagation is Wave-2 scope.
 *
 * @see TenantContext
 * @see <a href="../../../../../../../../docs/governance/stories/E14S03.story.md">Story E14S03</a>
 * @see <a href="../../../../../../../../docs/governance/stories/E14S01.story.md">Story E14S01 (AC-NESTED-BIND)</a>
...
public class ThreadLocalTenantContextImpl implements TenantContext {
    ...
    public UUID current() {
        ...
        if (top == null) {
            throw new IllegalStateException(
                    ...
                    + "Callers must establish a TenantContext.Scope via bind(tenantId) "
                    + "before invoking current(). See TenantContext Javadoc for the "
                    + "transactional semantics constraint (bind before @Transactional entry).");
        }
        return top;
    }
     ...
     * {@inheritDoc}
     *
     * <p>Pushes {@code tenantId} onto the per-thread stack. Closing the returned
     * {@link Scope} pops it, restoring the previous tenant (or leaving the stack empty
